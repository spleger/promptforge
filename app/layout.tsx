    ...
    <ClerkProvider
      appearance={{
        ...
        elements: {
          ...
          userButtonPopoverCustomItemButton: 'text-slate-300 hover:bg-slate-800',
          userButtonPopoverCustomItemButtonText: 'text-slate-300',
          userButtonPopoverCustomItemButtonIcon: 'text-slate-300',
